/*
 * This file illustrates ModExp.java from hw3.
 */
package hw3;

/**
 * Class that executes modulo.
 *
...
public class ModExp implements Expression {
    ...
    /**
     * ModExp constructor that initializes all its instance fields
     *
     * @param left  left operand
     * @param right right operand
     */
    public ModExp(Expression L, Expression R) {
        left = L;
        right = R;
    }

    /**
     * Gives a number evaluation of modulo
     *
